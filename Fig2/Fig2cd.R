...
# save(res, file = "Fig2/Fig2cd.RData")
# load(file = "Fig2/Fig2cd.RData")
...
haploRep <- rename(res, "GD init" = gd, "Homing" = drive, "GD/GD" = homoGD, "GD Heterozygotes" = heteroGD, "WT/WT" = homoWT) %>%
...
ggsave(plot = p, path = "Fig2", filename = "Fig2.png", height = 20, width = 20, unit = "cm")
